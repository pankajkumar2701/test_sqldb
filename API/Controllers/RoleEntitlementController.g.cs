...
using test_sqldb.Models;
using test_sqldb.Data;
using test_sqldb.Filter;
using test_sqldb.Entities;
using test_sqldb.Authorization;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.JsonPatch;
using System.Linq.Expressions;

namespace test_sqldb.Controllers
{
    /// <summary>
    ...
    {
        private readonly test_sqldbContext _context;

        public RoleEntitlementController(test_sqldbContext context)
        {
            _context = context;
        }
