...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "test_sqldb", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<test_sqldbContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "test_sqldb API v1");
